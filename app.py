...
groq_api_key = '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'  # Groq API key
os.environ["TAVILY_API_KEY"] = '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'  # Set Tavily API key
